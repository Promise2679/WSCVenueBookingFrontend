 ...
 * 统计数据
 */
export const getApiVenueStats = <ThrowOnError extends boolean = false>(options?: Options<GetApiVenueStatsData, ThrowOnError>) => (options?.client ?? client).get<GetApiVenueStatsResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/venue/stats',
    ...options
});
